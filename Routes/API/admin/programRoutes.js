...
programRoutes.get('/getCategories', programController.getCategories);
programRoutes.get('/getSubCategories/:categoryId', programController.getSubCategories);
...
programRoutes.delete('/deleteCourse/:programId', programController.deleteprogram);
