...
//     }
// });
bookAppointment.get('/book/:appointmentId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var appointment;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (appointment == null) {
                    ...
                    res.render('appointment-details-page', {
                        appointment: appointment
                    });
                }
                return [2 /*return*/];
...
// bookAppointment.post('/add',bookAppointmentController.addAppointmentBooking);
