...
// learn.get('/purchaseprogram/:programId',programController.purchaseprogram);
learn.get('/program/:programId/:moduleId/:lessonId', programController.lesson);
learn.get('/account', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, newuser;
...
learn.get('/changePassword', function (req, res) {
    console.log(req.cookies.authLearnerToken);
    res.render('change-password', {
        laearnerId: ''
    });
});
learn.get('/live', function (req, res) {
    res.render('learn/learner-live');
});
learn.get('/billing', function (req, res) {
    res.render('learn/learner-billing');
});
learn.get('/help-and-support', function (req, res) {
    res.render('learn/learner-support', {
        error: '',
        success: ''
    });
});
