...
var manageMembers = express_1.default.Router();
manageMembers.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var learners, groups;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, learnerModel_1.default(res.get('userName')).find({}).sort({ _id: -1 })];
            case 1:
                learners = _a.sent();
