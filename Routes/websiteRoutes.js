    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                settings = AxiosResponse.data;
                res.render('admin/create-website.ejs', {
                    isWebsiteActive: settings['isWebsiteActive'],
                    isGoToPageActive: settings['isGoToPageActive'],
                    websiteDetails: settings['websiteDetails'],
                    goToPageDetails: settings['goToPageDetails'],
                });
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
...
websiteRoutes.get('/gotoPage/edit', gotoController.initEditGotoPage);
