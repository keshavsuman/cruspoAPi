...
function getCourses(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var courses, currencies, courseCategory, e_1;
...
function getEditCourse(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var course, courseCategory, currencies, courseSubCategories, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, programModel_1.default(res.get('userName')).findById(req.params.courseID).populate({
                            path: 'batches',
                            match: { status: { $in: ['ACTIVE'] } }
                        })];
                case 1:
                    course = _a.sent();
                    console.log(course === null || course === void 0 ? void 0 : course.programType);
                    return [4 /*yield*/, programCategoryModel_1.default(res.get('userName')).find({})];
                case 2:
                    courseCategory = _a.sent();
                    return [4 /*yield*/, currencyModel_1.default.find()];
                ...
                case 4:
                    ...
                    console.log(course === null || course === void 0 ? void 0 : course.programType);
                    if ((course === null || course === void 0 ? void 0 : course.programType) == 'live-program') {
                    ...
                    else if ((course === null || course === void 0 ? void 0 : course.programType) == 'pre-recorded-program') {
                        console.log(';asg');
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    _c.label = 2;
                case 2: return [4 /*yield*/, programModel_1.default(res.get('userName')).create({
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, programModel_1.default(res.get('userName')).findByIdAndDelete()];
                case 1:
                    _a.sent();
                    res.send();
                    return [3 /*break*/, 3];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    batch = new (batchModel_1.default(res.get('userName')))();
                    batch.batchTitle = req.body.batchTitle;
                    batch.batchDescription = req.body.batchDescription;
                    return [4 /*yield*/, batch.save()];
                case 1:
                    batch = _a.sent();
                    return [4 /*yield*/, programModel_1.default(res.get('userName')).findByIdAndUpdate(req.params.courseID, { $push: { batches: batch['_id'] } })];
                case 2:
                    _a.sent();
                    console.log(batch);
                    return [3 /*break*/, 4];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    ...
                                                    return [4 /*yield*/, lessonModel_1.default(res.get('userName')).create({
                                    ...
                                    return [4 /*yield*/, moduleModel_1.default(res.get('userName')).create({
                    ...
                    return [4 /*yield*/, programModel_1.default(res.get('userName')).findById(req.params.courseID)];
                case 1:
                    course = _a.sent();
                    return [4 /*yield*/, programModel_1.default(res.get('userName')).findByIdAndUpdate(req.params.courseID, {
                            courseTitle: req.body.courseTitle,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    // await programModel.findByIdAndUpdate(req.params.courseID,updateDocument);
